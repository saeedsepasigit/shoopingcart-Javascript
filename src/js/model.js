const products = [
  ...
  },
  {
    ...
    description:
      'Spatial audio with dynamic head tracking places sounds all around you to create a three-dimensional listening experience for music TV shows, movies, and more — immersing you in sounds from every direction so it feels like youre in your very own concert hall or theater',
    image:
